...
- 电磁场、固体物理、信号与系统、数电各保留自己的主学习块；模电 P2 内容一律不以压缩睡眠或其他课程为代价。
...
**核心模拟（20 分钟，满分 100）：** 严格执行题本中的 M1-0～M1-7：M1-0 的 2 分钟包含 60 秒主答、三次各约 15 秒追问及约 15 秒读题/切换，随后完成 3 个基础快问、2 个画图分析、1 个推导和 1 个跨域系统连接。考官开始读题即计时，到时停止；这 20 分钟产生今天唯一的模拟总分。
